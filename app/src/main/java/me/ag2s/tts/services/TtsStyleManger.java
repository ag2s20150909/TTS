...
public class TtsStyleManger {
    ...
    private TtsStyleManger() {
        styles = new ArrayList<>(21);
        styles.add(new TtsStyle("默认", "Default", "默认值"));
        styles.add(new TtsStyle("新闻", "newscast", "以正式专业的语气叙述新闻"));
        styles.add(new TtsStyle("新闻(随意）", "newscast-casual", "以通用和随意的语气叙述新闻。"));
        styles.add(new TtsStyle("新闻(专业）", "newscast-formal", "以正式、自信、权威的语气叙述新闻。"));
        ...
        styles.add(new TtsStyle("欢快", "cheerful", "以较高的音调和音量表达欢快、热情的语气"));//Cheerful Happy
        ...
        styles.add(new TtsStyle("亲切", "affectionate", "以较高的音调和音量表达温暖而亲切的语气。 说话者处于吸引听众注意力的状态。 说话者的“个性”往往是讨人喜欢的。"));//Affectionate Cutesy
        styles.add(new TtsStyle("温和", "gentle", "以较低的音调和音量表达温和、礼貌和愉快的语气"));//Gentle
        styles.add(new TtsStyle("优美", "lyrical", "以优美又带感伤的方式表达情感"));
        styles.add(new TtsStyle("专业旁白", "narration-professional", "对内容阅读表达专业、客观的语气。（云扬，Aria）"));
        styles.add(new TtsStyle("尴尬", "embarrassed", "在说话者感到不舒适时表达不确定、犹豫的语气"));//Shy
        styles.add(new TtsStyle("同情心", "empathetic", "表达出一种关怀和理解的感觉。"));
